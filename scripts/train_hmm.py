...
print("\nHMM – 5-fold CV on SIMPLIFIED tagset")
...
print("\nSample qualitative errors (HMM, simplified):")
...
with open("hmm_qual_errors_simplified.tsv", "w", encoding="utf-8") as f:
...
print("\nSaved qualitative errors to: hmm_qual_errors_simplified.tsv")
...
ax.set_title("HMM – Per-tag F1 (5-fold CV, simplified)")
plt.tight_layout()
plt.savefig("hmm_per_tag_f1_simplified_cv.png", dpi=300)
plt.close(fig)

print("\nSaved plot to: hmm_per_tag_f1_simplified_cv.png")